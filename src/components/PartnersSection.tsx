    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8" id="partners-page-root">
      ...
      <div className="space-y-4" id="official-sponsors-section">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* ALGOTECH Banner - 3rd Most Important Sponsor (Cloud VPS) */}
          <div className="bg-gradient-to-br from-slate-900 via-slate-850 to-emerald-950 rounded-3xl border-2 border-emerald-500/50 p-6 text-white shadow-xl relative overflow-hidden flex flex-col justify-between space-y-4" id="algotech-official-sponsor-banner">
            ...
            <div className="space-y-3 relative z-10">
              <div className="flex items-start gap-3.5">
                <div className="w-14 h-14 rounded-2xl bg-white p-2 shadow-md border border-slate-200 shrink-0 flex items-center justify-center overflow-hidden">
                  <img 
                    src="https://www.algotech.cz/files/logo.svg" 
                    alt="ALGOTECH Logo" 
                    ...
                    onError={(e) => {
                      ...
                      if (parent && !parent.querySelector('.fallback-algotech')) {
                        const fallback = document.createElement('span');
                        fallback.className = 'fallback-algotech text-slate-900 font-extrabold text-xs font-mono text-center';
                        fallback.innerText = 'ALGOTECH';
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    <span className="bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 text-[9px] font-mono font-bold uppercase px-2 py-0.5 rounded-full flex items-center gap-1">
                      <Award className="w-3 h-3 text-emerald-400" />
                      3. Nejdůležitější Sponzor
                    </span>
              ...
              <p className="text-slate-300 text-xs leading-relaxed">
                Společnost <strong>ALGOTECH a.s.</strong> se stala třetím klíčovým sponzorem projektu a poskytla bezplatný vysokovýkonný <strong>Cloud VPS server</strong> pro spolehlivý chod backendových mikroslužeb, databází a AI asistentů.
              </p>
            </div>
            ...
            <div className="pt-3 flex items-center justify-between border-t border-slate-800 relative z-10">
              <a
                ...
                className="px-4 py-2 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-extrabold text-xs rounded-xl transition-all shadow-md flex items-center gap-1.5 cursor-pointer"
              >
                <span>Navštívit ALGOTECH.cz</span>
                <ExternalLink className="w-3.5 h-3.5" />
              </a>
              <span className="text-[10px] text-slate-400 font-mono">Česko / Praha</span>
            </div>
          </div>
