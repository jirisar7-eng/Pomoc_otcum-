    ...
    <div className="space-y-6" id="forum-section-container">
      ...
      {!selectedCategoryId && !selectedPostId && (
        <div className="space-y-8" id="forum-categories-view">
          ...
          <div className="bg-gradient-to-r from-blue-900 via-indigo-900 to-slate-900 text-white rounded-2xl p-6 border border-blue-500/30 shadow-lg relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6" id="facebook-group-forum-banner">
            <div className="absolute top-0 right-0 w-64 h-64 bg-blue-500/10 rounded-full blur-3xl pointer-events-none" />
            
            <div className="space-y-2 relative z-10 max-w-2xl">
              <div className="flex items-center gap-2">
                <span className="bg-blue-500/30 text-blue-200 border border-blue-400/40 text-[10px] font-mono font-bold uppercase px-2.5 py-0.5 rounded-full flex items-center gap-1">
                  <Share2 className="w-3 h-3 text-blue-300" />
                  Oficiální Facebook Skupina Portálu
                </span>
                <span className="bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 text-[10px] font-mono font-bold uppercase px-2 py-0.5 rounded-full flex items-center gap-1">
                  <Users className="w-3 h-3 text-emerald-300" />
                  Rozšíření na sociální sítě
                </span>
              </div>
              
              <h3 className="text-lg md:text-xl font-bold font-display text-white">
                Připojte se k naší komunitní skupině na Facebooku
              </h3>
              
              <p className="text-xs sm:text-sm text-slate-200 leading-relaxed font-sans">
                Chcete diskutovat s dalšími táty a rodiči v reálném čase přímo na sociálních sítích? Naše oficiální Facebook skupina slouží jako rozšíření portálu <strong>Táta má právo</strong> pro rychlé dotazy, sdílení zkušeností a vzájemnou podporu.
              </p>
            </div>
            ...
            <a
              ...
              className="px-5 py-3 bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-xs rounded-xl transition-all shadow-md flex items-center gap-2 shrink-0 cursor-pointer hover:scale-105 active:scale-95 whitespace-nowrap relative z-10 border border-blue-400/40"
            >
              <span>Vstoupit do Facebook skupiny</span>
