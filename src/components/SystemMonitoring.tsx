        ...
        <section className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {[
              ...
              { name: 'WEDOS SMTP & Firebase Realtime DB', desc: 'Služba nodemailer + Firebase Realtime DB pro 6místné kódové úložiště (10 min TTL)', purpose: 'Odesílání přihlašovacích kódů, magic linků a notifikací', status: '200 OK', speed: '120 ms', err: 'Žádná chyba', advice: 'SMTP & Realtime DB store aktivní (info@tatovacesta.cz).' },
              { 
